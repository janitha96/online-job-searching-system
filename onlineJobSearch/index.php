...
<?php 
  if (isset($_SESSION['u_name'])) {
    ...
    <div class="col-12 col-sm-12 col-md-10 col-lg-10" style="background-color: white; height: 250px; border-radius: 10px;">
      <div class="row justify-content-center">
        <div class="col-12 col-sm-12 col-md-10 col-lg-10">
         <p>Find your Job using J O B .lk</p>
          <select class="form-control" style="border-radius: 0px; border-color: black;">
            <option> All</option>
            <option> 1</option>
            <option> 1</option>
            <option> 1</option>
